...
def search_tab(keyword, tab, start_date):
    ...
    data = {"query":"창업","reQuery":"0","realQuery":"","startCount":"0","collection":"businessinfo","sort":"DATE","startDate":"","endDate":"","listCount":"10","searchField":""}
    # data = {
    #     'startCount': 0,
    #     'sort': 'DATE/DESC',
    #     'collection': tab,
...
if __name__ == "__main__":
    log_debug("crawl_sup_v1.py START")
    ...
    for task in CRAWL_LIST:
        try:
            ...
            log_error("crawl_sup_v1.py ERROR")
            log_error(str(e))
            # insert_crawl_log(['C', task[1], task[0]])  # 크롤링 로그 : 자체 오류

    log_debug("crawl_sup_v1.py FINISH")
